...
return [
    ...
    'errors' => [
        ...
        'voucher_other_dupe' => 'It looks like the code (:code) has been used already, please double check and try again. If you are still unable to add the voucher code, don\'t worry you will still be paid. Please email admin@alexandrarose.org.uk to let us know that this happened and give the voucher number.',
        ...
        'voucher_unavailable' => 'Sorry that code is not available. Please check the code including the letters. You can change the letters when you enter the code by using the backspace key.',
    ]
];
