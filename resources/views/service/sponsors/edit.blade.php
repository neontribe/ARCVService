            ...
            <form role="form" method="POST" action="{{ route('admin.sponsors.update', ['id' => $sponsor->id]) }}">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="householdExistsValue" id="householdExistsValue"
                                   value="{{ $householdExistsValue }}"
                                   min="0" class="{{ $errors->has('householdExistsValue') ? 'has-error' : '' }}"
                                   required>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="number" name="householdMemberValue" id="householdMemberValue"
                                   value="{{ $householdMemberValue }}"
                                   min="0" class="{{ $errors->has('householdMemberValue') ? 'has-error' : '' }}"
                                   required>
                        </td>
                    </tr>
                    </tbody>
