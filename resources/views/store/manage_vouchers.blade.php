        ...
        <div class="col-container">
            ...
            <div class="col allocation">
                ...
                <form method="post" action="{{ route('store.registration.vouchers.post', [ 'registration' => $registration->id ]) }}">
                    ...
                    <div class="alongside-container">
                        <label>First voucher
                        <input id="first-voucher" name="start" type="text" data-prefix="{{  $registration->centre->sponsor->shortcode }}" autofocus class="uppercase">
                        </label>
                        <label>Last voucher
                            <input id="last-voucher" name="end" type="text" data-prefix="{{ $registration->centre->sponsor->shortcode }}" class="uppercase">
                        </label>
                ...
                {!! csrf_field() !!}
                    <div class="single-container">
                        ...
                        <input id="single-voucher" name="start" type="text" data-prefix="{{ $registration->centre->sponsor->shortcode }}" class="uppercase">
                        </label>
    ...
    <script type="text/javascript">
        $(document).ready(
            function () {
                ...
                //Vouchers data-prefix autopopulation
                $("data-prefix").keydown(function (e) {
                    $("input") .addClass()
                }
