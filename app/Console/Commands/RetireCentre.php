...
class RetireCentre extends Command
{
    ...
    public function handle(): int
    {
        ...
        try {
            DB::transaction(function () use ($centre, $removeRegistrations, $removeFamilies) {
                ...
                $this->markFamiliesAsLeft($centre);
     ...
     */
    public function retireCentreUsers(Centre $centre): void
    {
     ...
     */
    public function markFamiliesAsLeft(Centre $centre): void
    {
        $affected = Family::whereHas('registrations', function ($q) use ($centre) {
     ...
     */
    public function freeVouchersFromUndisbursedBundles(Centre $centre): void
    {
     ...
     */
    public function removeRegistrationsAndBundles(Centre $centre): void
    {
     ...
     */
    public function removeFamilies(Centre $centre): void
    {
