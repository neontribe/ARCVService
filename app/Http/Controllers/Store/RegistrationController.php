...
//        DEBUG STUFF
//        http://arcv-store.test:8001/registrations?_token=HgiYN3ijYL2slb9gnatGjTcsb0l139yQ7f6nRODd&family_name=habibah&fuzzy=0
//        $_family_name = habibah
//        $_fuzzy = 0
//        $filtered_family_ids [10576]
//        $_families_left = null
//        $_centre = null
        $_rm = $q->get();
        foreach ($_rm as $r) {
